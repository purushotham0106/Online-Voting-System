...
<div class="header">
	...
	<div class="head-middle-bottom">
		...
		<input id ="nav" type="submit" name="admin" value="Admin Home">
...
<h2>Operation Failed. Please return Home and try again.</h2>
<img src="https://d2v9ipibika81v.cloudfront.net/uploads/sites/269/750x450-vote.jpg"/>
</div>
<div class="footer">
