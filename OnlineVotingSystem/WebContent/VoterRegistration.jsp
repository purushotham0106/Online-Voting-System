...
.footer{
 ...
 function validation() {
	    ...
	    if(!(ssn.match(letter)) || snn.length<12)
	    {
	    alert('SSN should can only be alphanumeric and length is 12 characters.');
...
<div class="main">
	...
	<div class="login-head">Voter's Registration</div>
	...
	<input type="hidden" name="parameter" value="addVoter"><br/>
