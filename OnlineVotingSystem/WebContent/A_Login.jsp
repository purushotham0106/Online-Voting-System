  ...
  <div class="container-fluid">
    <div class="navbar-header">
	 ...
	 <ul class="nav navbar-nav navbar-right">
      ...
      <li><a style="color:white;" href="/OnlineVotingSystem/Login.jsp"><span class="glyphicon glyphicon-log-in"></span>Voter Login</a></li>
    </ul>
  </div>
</nav>	
	<div class="limiter">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="VotingServlet">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" name="parameter" value="login">
							Login
						</button>
					</div>
